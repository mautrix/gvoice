...
func (x *EventSub1) GetUnknown1() string {
	if x != nil {
		return x.Unknown1
	}
	return ""
...
const file_webchannel_proto_rawDesc = "" +
	"\n" +
	"\x10webchannel.proto\x12\n" +
	"webchannel\"R\n" +
	"\x10RespChooseServer\x12\x1e\n" +
	"\n" +
	"gSessionID\x18\x01 \x01(\tR\n" +
	"gSessionID\x12\x1e\n" +
	"\n" +
	"unknownInt\x18\x02 \x01(\x05R\n" +
	"unknownInt\"J\n" +
	"\x11RespCreateChannel\x125\n" +
	"\x04data\x18\x01 \x01(\v2!.webchannel.WebChannelSessionDataR\x04data\"h\n" +
	"\x15WebChannelSessionData\x12\x16\n" +
	"\x06field1\x18\x01 \x01(\x05R\x06field1\x127\n" +
	"\asession\x18\x02 \x01(\v2\x1d.webchannel.WebChannelSessionR\asession\"\xb5\x01\n" +
	"\x11WebChannelSession\x12\x16\n" +
	"\x06field1\x18\x01 \x01(\tR\x06field1\x12\x1c\n" +
	...
	"\x06field5\x18\x05 \x01(\rR\x06field5\x12\"\n" +
	"\fpingInterval\x18\x06 \x01(\rR\fpingInterval\"v\n" +
	"\x0fWebChannelEvent\x12\x18\n" +
	"\aarrayID\x18\x01 \x01(\x04R\aarrayID\x12I\n" +
	"\fdata_wrapper\x18\x02 \x03(\v2&.webchannel.WebChannelEventDataWrapperR\vdataWrapper\"C\n" +
	"\x13WebChannelNoopEvent\x12\x18\n" +
	"\aarrayID\x18\x01 \x01(\x04R\aarrayID\x12\x12\n" +
	"\x04noop\x18\x02 \x03(\tR\x04noop\"\xc4\x01\n" +
	"\x1aWebChannelEventDataWrapper\x123\n" +
	"\x04data\x18\x01 \x03(\v2\x1f.webchannel.WebChannelEventDataR\x04data\x12H\n" +
	"\aaltData\x18\x02 \x01(\v2..webchannel.WebChannelEventDataWrapper.AltDataR\aaltData\x1a'\n" +
	"\aAltData\x12\x1c\n" +
	"\treconnect\x18\x01 \x01(\bR\treconnect\"`\n" +
	"\x13WebChannelEventData\x12 \n" +
	"\veventSource\x18\x01 \x01(\tR\veventSource\x12'\n" +
	"\x05event\x18\x02 \x01(\v2\x11.webchannel.EventR\x05event\"\x88\x01\n" +
	"\x05Event\x12)\n" +
	"\x04sub1\x18\x01 \x01(\v2\x15.webchannel.EventSub1R\x04sub1\x12)\n" +
	"\x04sub2\x18\x02 \x01(\v2\x15.webchannel.EventSub2R\x04sub2\x12)\n" +
	"\x04sub3\x18\x03 \x01(\v2\x15.webchannel.EventSub3R\x04sub3\"\a\n" +
	"\x05Empty\"'\n" +
	"\tEventSub1\x12\x1a\n" +
	"\bunknown1\x18\x01 \x01(\tR\bunknown1\":\n" +
	"\tEventSub2\x12-\n" +
	"\x04data\x18\x01 \x03(\v2\x19.webchannel.EventSub2DataR\x04data\"\x96\x03\n" +
	"\rEventSub2Data\x12\"\n" +
	"\funknownBytes\x18\x02 \x01(\fR\funknownBytes\x126\n" +
	"\x16unknownTimestampMillis\x18\x03 \x01(\tR\x16unknownTimestampMillis\x126\n" +
	"\x16unknownTimestampMicros\x18\x04 \x01(\tR\x16unknownTimestampMicros\x12R\n" +
	"\x11unknownNestedData\x18\x05 \x01(\v2$.webchannel.EventSub2Data.NestedDataR\x11unknownNestedData\x1a\x9c\x01\n" +
	"\n" +
	"NestedData\x12\x10\n" +
	"\x03ts1\x18\x01 \x01(\tR\x03ts1\x12\x10\n" +
	"\x03ts2\x18\x02 \x01(\tR\x03ts2\x12\x10\n" +
	"\x03ts3\x18\x03 \x01(\tR\x03ts3\x12\x10\n" +
	"\x03ts4\x18\x04 \x01(\tR\x03ts4\x12\x10\n" +
	"\x03ts5\x18\x05 \x01(\tR\x03ts5\x12\x10\n" +
	"\x03ts6\x18\x06 \x01(\tR\x03ts6\x12\x10\n" +
	"\x03ts7\x18\a \x01(\tR\x03ts7\x12\x10\n" +
	"\x03ts9\x18\t \x01(\tR\x03ts9\"7\n" +
	"\tEventSub3\x12*\n" +
	"\x10unknownTimestamp\x18\x01 \x01(\tR\x10unknownTimestampB\fZ\n" +
	"../gvprotob\x06proto3"

var (
	file_webchannel_proto_rawDescOnce sync.Once
	file_webchannel_proto_rawDescData []byte
)

func file_webchannel_proto_rawDescGZIP() []byte {
	file_webchannel_proto_rawDescOnce.Do(func() {
		file_webchannel_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_webchannel_proto_rawDesc), len(file_webchannel_proto_rawDesc)))
	})
...
var file_webchannel_proto_depIdxs = []int32{
	...
	15, // 10: webchannel.EventSub2Data.unknownNestedData:type_name -> webchannel.EventSub2Data.NestedData
...
func file_webchannel_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_webchannel_proto_rawDesc), len(file_webchannel_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   0,
