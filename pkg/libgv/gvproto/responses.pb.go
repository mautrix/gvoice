...
const file_responses_proto_rawDesc = "" +
	"\n" +
	"\x0fresponses.proto\x12\tresponses\x1a\rthreads.proto\x1a\raccount.proto\x1a\x0econtacts.proto\"8\n" +
	"\rRespGetThread\x12'\n" +
	"\x06thread\x18\x01 \x01(\v2\x0f.threads.ThreadR\x06thread\"`\n" +
	"\x0fRespListThreads\x12)\n" +
	"\athreads\x18\x01 \x03(\v2\x0f.threads.ThreadR\athreads\x12\"\n" +
	"\fversionToken\x18\x03 \x01(\tR\fversionToken\"\xac\x01\n" +
	"\vRespSendSMS\x12\x1a\n" +
	"\bthreadID\x18\x02 \x01(\tR\bthreadID\x12\"\n" +
	"\fthreadItemID\x18\x03 \x01(\tR\fthreadItemID\x12 \n" +
	"\vtimestampMS\x18\x04 \x01(\x03R\vtimestampMS\x12;\n" +
	"\rthreadFolders\x18\x05 \x03(\x0e2\x15.threads.ThreadFolderR\rthreadFolders\"Q\n" +
	"\x14RespUpdateAttributes\x129\n" +
	"\n" +
	"attributes\x18\x01 \x01(\v2\x19.threads.ThreadAttributesR\n" +
	"attributes\"R\n" +
	"\x19RespBatchUpdateAttributes\x125\n" +
	"\x05items\x18\x01 \x01(\v2\x1f.responses.RespUpdateAttributesR\x05items\"<\n" +
	"\x0eRespGetAccount\x12*\n" +
	"\aaccount\x18\x01 \x01(\v2\x10.account.AccountR\aaccount\"\x12\n" +
	"\x10RespDeleteThread\"\x8c\x05\n" +
	"\x18RespAutocompleteContacts\x121\n" +
	"\aresults\x18\x01 \x03(\v2\x17.contacts.PersonWrapperR\aresults\x12u\n" +
	"\x17affinityResponseContext\x18\x02 \x01(\v2;.responses.RespAutocompleteContacts.AffinityResponseContextR\x17affinityResponseContext\x1a\xc5\x03\n" +
	"\x17AffinityResponseContext\x12(\n" +
	"\x0faffinityVersion\x18\x01 \x01(\x05R\x0faffinityVersion\x12_\n" +
	"\bfeatures\x18\x03 \x03(\v2C.responses.RespAutocompleteContacts.AffinityResponseContext.FeatureR\bfeatures\x1a\x9e\x02\n" +
	"\aFeature\x12\\\n" +
	"\x04type\x18\x01 \x01(\x0e2H.responses.RespAutocompleteContacts.AffinityResponseContext.Feature.TypeR\x04type\x12\x16\n" +
	"\x06weight\x18\x02 \x01(\x01R\x06weight\x12\x1a\n" +
	"\bexponent\x18\x03 \x01(\x01R\bexponent\"\x80\x01\n" +
	"\x04Type\x12\x10\n" +
	"\fUNKNOWN_TYPE\x10\x00\x12\x16\n" +
	"\x12IS_CONTACT_STARRED\x10\x06\x12\x16\n" +
	"\x12HAS_POSTAL_ADDRESS\x10\a\x12\x10\n" +
	"\fHAS_NICKNAME\x10\b\x12\x0e\n" +
	"\n" +
	"HAS_AVATAR\x10\v\x12\x14\n" +
	"\x10NUM_RAW_CONTACTS\x10\x10\"\xc4\x02\n" +
	"\x12RespLookupContacts\x12=\n" +
	"\amatches\x18\x01 \x03(\v2#.responses.RespLookupContacts.MatchR\amatches\x1a\xee\x01\n" +
	"\x05Match\x12#\n" +
	"\x02ID\x18\x01 \x01(\v2\x13.contacts.ContactIDR\x02ID\x12?\n" +
	"\x0eautocompletion\x18\x02 \x01(\v2\x17.contacts.PersonWrapperR\x0eautocompletion\x12Q\n" +
	"\vfailureType\x18\x03 \x01(\x0e2/.responses.RespLookupContacts.Match.FailureTypeR\vfailureType\",\n" +
	"\vFailureType\x12\x0e\n" +
	"\n" +
	"NO_FAILURE\x10\x00\x12\r\n" +
	"\tPERMANENT\x10\x01B\fZ\n" +
	"../gvprotob\x06proto3"
