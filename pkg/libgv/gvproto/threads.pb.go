...
const file_threads_proto_rawDesc = "" +
	"\n" +
	"\rthreads.proto\x12\athreads\"\xe7\x02\n" +
	"\x06Thread\x12\x0e\n" +
	"\x02ID\x18\x01 \x01(\tR\x02ID\x12\x12\n" +
	"\x04read\x18\x02 \x01(\bR\x04read\x12,\n" +
	"\bmessages\x18\x03 \x03(\v2\x10.threads.MessageR\bmessages\x12(\n" +
	"\x0fpaginationToken\x18\x04 \x01(\tR\x0fpaginationToken\x12,\n" +
	"\bcontacts\x18\x05 \x03(\v2\x10.threads.ContactR\bcontacts\x12/\n" +
	"\afolders\x18\x06 \x03(\x0e2\x15.threads.ThreadFolderR\afolders\x12\x16\n" +
	"\x06isText\x18\b \x01(\bR\x06isText\x12\"\n" +
	"\fphoneNumbers\x18\t \x03(\tR\fphoneNumbers\x12F\n" +
	"\x15suspectedSpamContacts\x18\f \x03(\v2\x10.threads.ContactR\x15suspectedSpamContacts\"\xbc\x02\n" +
	"\x10ThreadAttributes\x12\x1a\n" +
	"\bthreadID\x18\x01 \x01(\tR\bthreadID\x12\x1c\n" +
	"\tisBlocked\x18\x02 \x01(\bR\tisBlocked\x12\x1c\n" +
	"\tisSpammer\x18\x03 \x01(\bR\tisSpammer\x12\x12\n" +
	...
	"\n" +
	"coarseType\x18\r \x01(\x0e2\x1b.threads.Message.CoarseTypeR\n" +
	"coarseType\x12M\n" +
	"\x10transcriptStatus\x18\x0e \x01(\x0e2!.threads.Message.TranscriptStatusR\x10transcriptStatus\x12%\n" +
	"\x03MMS\x18\x0f \x01(\v2\x13.threads.MMSMessageR\x03MMS\x12D\n" +
	"\x1dphoneNumberKeyToThreadContact\x18\x10 \x01(\tR\x1dphoneNumberKeyToThreadContact\x12:\n" +
	"\x18isArtificialErrorMessage\x18\x11 \x01(\bR\x18isArtificialErrorMessage\x12$\n" +
	"\rtransactionID\x18\x12 \x01(\x03R\rtransactionID\x12A\n" +
	"\fuserFeedback\x18\x13 \x01(\v2\x1d.threads.Message.UserFeedbackR\fuserFeedback\x1a~\n" +
	"\fUserFeedback\x12<\n" +
	...
	"\x04READ\x10\x01\"4\n" +
	"\x10TranscriptStatus\x12\x12\n" +
	"\x0eUNKNOWN_STATUS\x10\x00\x12\f\n" +
	"\bRECEIVED\x10\x01\"\x9b\x02\n" +
	"\n" +
	"MMSMessage\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12\x18\n" +
	"\asubject\x18\x02 \x01(\tR\asubject\x125\n" +
	"\vattachments\x18\x03 \x03(\v2\x13.threads.AttachmentR\vattachments\x124\n" +
	"\fparticipants\x18\x04 \x03(\v2\x10.threads.ContactR\fparticipants\x12,\n" +
	"\x11senderPhoneNumber\x18\x05 \x01(\tR\x11senderPhoneNumber\x12D\n" +
	"\x1dphoneNumberKeyToThreadContact\x18\x06 \x03(\tR\x1dphoneNumberKeyToThreadContact\"\x89\x04\n" +
	"\n" +
	"Attachment\x12\x1a\n" +
	"\bmimeType\x18\x01 \x01(\tR\bmimeType\x12\x0e\n" +
	"\x02ID\x18\x02 \x01(\tR\x02ID\x122\n" +
	"\x06status\x18\x03 \x01(\x0e2\x1a.threads.Attachment.StatusR\x06status\x128\n" +
	"\bmetadata\x18\x04 \x03(\v2\x1c.threads.Attachment.MetadataR\bmetadata\x12;\n" +
	"\tmediaType\x18\x05 \x01(\x0e2\x1d.threads.Attachment.MediaTypeR\tmediaType\x1a\xb9\x01\n" +
	"\bMetadata\x129\n" +
	"\x04size\x18\x01 \x01(\x0e2%.threads.Attachment.Metadata.SizeSpecR\x04size\x12\x14\n" +
	"\x05width\x18\x02 \x01(\x05R\x05width\x12\x16\n" +
	"\x06height\x18\x03 \x01(\x05R\x06height\"D\n" +
	"\bSizeSpec\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\f\n" +
	"\bORIGINAL\x10\x01\x12\b\n" +
	"\x04S128\x10\x02\x12\b\n" +
	"\x04S512\x10\x03\x12\t\n" +
	"\x05S1280\x10\x04\">\n" +
	"\x06Status\x12\x12\n" +
	"\x0eUNKNOWN_STATUS\x10\x00\x12\r\n" +
	"\tAVAILABLE\x10\x01\x12\x11\n" +
	"\rNOT_SUPPORTED\x10\x03\"(\n" +
	"\tMediaType\x12\x10\n" +
	...
	"\ablocked\x18\a \x01(\bR\ablocked*\xad\x01\n" +
	"\fThreadFolder\x12\x19\n" +
	"\x15UNKNOWN_THREAD_FOLDER\x10\x00\x12\x0f\n" +
	"\vALL_THREADS\x10\x01\x12\x10\n" +
	"\fTEXT_THREADS\x10\x02\x12\x14\n" +
	"\x10ALL_CALL_THREADS\x10\x03\x12\x19\n" +
	"\x15ALL_VOICEMAIL_THREADS\x10\x04\x12\x14\n" +
	"\x10ALL_SPAM_THREADS\x10\x05\x12\x18\n" +
	"\x14ALL_ARCHIVED_THREADS\x10\x06*R\n" +
	"\x14ContactSpammerStatus\x12\"\n" +
	"\x1eUNKNOWN_CONTACT_SPAMMER_STATUS\x10\x00\x12\x16\n" +
	"\x12USER_UNMARKED_SPAM\x10\x04B\fZ\n" +
	"../gvprotob\x06proto3"

var (
	file_threads_proto_rawDescOnce sync.Once
	file_threads_proto_rawDescData []byte
)

func file_threads_proto_rawDescGZIP() []byte {
	file_threads_proto_rawDescOnce.Do(func() {
		file_threads_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_threads_proto_rawDesc), len(file_threads_proto_rawDesc)))
	})
